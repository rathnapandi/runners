    ...
    return (
        <div>
                ...
                <div className="div4-Header2">
                    <div className="div4-Header2-div">
                        ...
                        <a href='https://teams.microsoft.com/l/channel/19%3a83d56744389742bb8a1f544e1c4d024f%40thread.tacv2/General?groupId=22fa248e-04a6-4727-825e-5c31b8eb8234&tenantId=300f59df-78e6-436f-9b27-b64973e34f7d'
                           target='_blank'><span>|</span>Support</a>
            ...
            <div style={{marginTop: '10px'}}>
                <NavLink className="button-folder" exact to='/index.html'  activeClassName='active-button'>
                    Challenge
                </NavLink>
                <NavLink className="button-folder"  to='/Dashboard' activeClassName='active-button'>
                    Dashboard
                </NavLink>
